      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <div className="flex space-x-3">
            <a href="https://facebook.com/duocuc" target="_blank" rel="noopener" aria-label="Facebook">
              <img src="/icons/facebook.svg" alt="Facebook" className="w-6 h-6"/>
            </a>
            <a href="https://instagram.com/duocuc" target="_blank" rel="noopener" aria-label="Instagram">
              <img src="/icons/instagram.svg" alt="Instagram" className="w-6 h-6"/>
            </a>
            <a href="https://linkedin.com/school/duoc-uc" target="_blank" rel="noopener" aria-label="LinkedIn">
