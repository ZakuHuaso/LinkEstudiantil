  ...
  return (
    <>
      ...
      <main className="max-w-4xl mx-auto py-8 space-y-12">
        ...
        <section>
          <h2 className="text-2xl font-bold text-blue-900 mb-4">Mis Requerimientos</h2>
                  ...
                  {requerimientos.length > 0 ? (
                    requerimientos.map((r) => (
                      <tr key={r.id} className="border-t hover:bg-gray-50">
                        ...
                        <td className="px-4 py-2">{r.respuesta || <span className="text-gray-400">—</span>}</td>
                        <td className="px-4 py-2">
                          {r.imagen_url ? (
                            <button
          ...
          {imagenSeleccionada && (
            <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
              <div className="bg-white p-4 rounded shadow-lg max-w-md w-full">
                <img src={imagenSeleccionada} alt="Preview" className="w-full h-auto rounded" />
